...
data = {"Вася": ("Палатка", "Котелок", "Топор", "Спирт"),
        "Петя": ("Палатка", "Котелок", "Спички"),
        "Саша": ("Палатка", "Котелок", "Спички", "Шашлык"),
        "Паша": ("Котелок", "Шашлык"),
        }
...
res_all = lst[0]
for things in lst[1:]:
    res_all = res_all.intersection(things)
print(f"{res_all} взяли все")
