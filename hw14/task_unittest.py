...
def numbers_check(num: int, min: int, max: int) -> str:
...
class TestCaseName(unittest.TestCase):
    ...
    def test_simple_number(self):
        self.assertEqual(numbers_check(1, 0, 100000), "Число является простым")

    def test_composite_number(self):
        self.assertEqual(numbers_check(99999, 0, 100000), "Число является составным")

    def test_wrong_number(self):
        self.assertEqual(numbers_check(100001, 0, 100000), "Введённое число не входит в заданный диапазон")
