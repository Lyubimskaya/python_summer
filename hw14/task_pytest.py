...
def test_simple_number():
    assert numbers_check(1, 0, 100000) == "Число является простым"

def test_composite_number():
    assert numbers_check(99999, 0, 100000) == "Число является составным"

def test_wrong_number():
    assert numbers_check(100001, 0, 100000) == "Введённое число не входит в заданный диапазон"
